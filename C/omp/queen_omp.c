...
bool queenAt(int row, int col, int queens[size]) { return queens[col] == row; }
...
void resolve(int col, int queens[size], unsigned long *num_solutions,
